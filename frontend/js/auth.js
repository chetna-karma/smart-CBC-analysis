...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (loginForm) {
        ...
        loginForm.addEventListener('submit', async (e) => {
            ...
            if (result.success && result.data) {
                window.showToast(result.data.message || 'Login successful!');
                ...
                window.showToast(result.message || 'Login failed. Please check your credentials.', 'error');
    ...
    if (registerForm) {
        ...
        registerForm.addEventListener('submit', async (e) => {
            ...
            if (result.success && result.data) {
                window.showToast(result.data.message || 'Registration successful!');
                
                // Auto-login: store token and user info immediately
                localStorage.setItem('token', result.data.token);
                localStorage.setItem('user', JSON.stringify(result.data.user));
                ...
                window.showToast(result.message || 'Registration failed. Try again.', 'error');
                submitBtn.disabled = false;
